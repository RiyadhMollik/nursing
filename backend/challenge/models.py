...
class DayRoutine(models.Model):
    ...
    bsc_lecture = models.CharField(max_length=120, blank=True)
    bsc_topic = models.TextField(blank=True)
    diploma_lecture = models.CharField(max_length=120, blank=True)
    diploma_topic = models.TextField(blank=True)
    motivational_line = models.TextField(blank=True)
